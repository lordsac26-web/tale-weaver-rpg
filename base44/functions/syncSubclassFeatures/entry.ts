...
const SUBCLASS_DATA = {
  ...
  Rogue: {
    'Thief': { 3: ['Fast Hands', 'Second-Story Work'], 9: ['Supreme Sneak'], 13: ['Use Magic Device'], 17: ["Thief's Reflexes (two turns in the first round)"] },
    'Arcane Trickster': { 3: ['Spellcasting', 'Mage Hand Legerdemain'], 9: ['Magical Ambush'], 13: ['Versatile Trickster'], 17: ['Spell Thief'] },
    'Assassin': { 3: ['Assassinate', 'Bonus Proficiencies'], 9: ['Infiltration Expertise'], 13: ['Impostor'], 17: ['Death Strike (double damage vs surprised targets, CON save)'] },
    'Swashbuckler': { 3: ['Fancy Footwork', 'Rakish Audacity'], 9: ['Panache'], 13: ['Elegant Maneuver'], 17: ['Master Duelist (reroll a missed attack, 1/short rest)'] },
  ...
  Wizard: {
    ...
    'School of Abjuration': { 2: ['Abjuration Savant', 'Arcane Ward'], 6: ['Projected Ward'], 10: ['Improved Abjuration'], 14: ['Spell Resistance (advantage on saves vs spells; resistance to spell damage)'] },
    'School of Illusion': { 2: ['Illusion Savant', 'Improved Minor Illusion'], 6: ['Malleable Illusions'], 10: ['Illusory Self'], 14: ['Illusory Reality (make an illusory object real for 1 minute)'] },
    'School of Necromancy': { 2: ['Necromancy Savant', 'Grim Harvest'], 6: ['Undead Thralls'], 10: ['Inured to Undeath'], 14: ['Command Undead (wrest control of an undead, CHA save)'] },
    'School of Divination': { 2: ['Divination Savant', 'Portent'], 6: ['Expert Divination'], 10: ['The Third Eye'], 14: ['Greater Portent (roll three Portent dice at dawn)'] },
    'School of Conjuration': { 2: ['Conjuration Savant', 'Minor Conjuration'], 6: ['Benign Transposition'], 10: ['Focused Conjuration'], 14: ['Durable Summons (summoned creatures gain 30 temp HP)'] },
  },
  Cleric: {
    'Life Domain': { 1: ['Bonus Proficiency (Heavy Armor)', 'Disciple of Life'], 2: ['Preserve Life'], 6: ['Blessed Healer'], 8: ['Divine Strike (+1d8 radiant, 2d8 at 14th)'], 17: ['Supreme Healing (healing dice are maximized)'] },
    'Light Domain': { 1: ['Bonus Cantrip', 'Warding Flare'], 2: ['Radiance of the Dawn'], 6: ['Improved Flare'], 8: ['Potent Spellcasting (+WIS to cantrip damage)'], 17: ['Corona of Light (aura of sunlight; disadvantage on saves vs fire/radiant spells)'] },
    'War Domain': { 1: ['Bonus Proficiencies', 'War Priest'], 2: ['Guided Strike'], 6: ["War God's Blessing"], 8: ['Divine Strike (+1d8 weapon damage, 2d8 at 14th)'], 17: ['Avatar of Battle (resistance to nonmagical B/P/S)'] },
    'Trickery Domain': { 1: ['Blessing of the Trickster'], 2: ['Invoke Duplicity'], 6: ['Cloak of Shadows'], 8: ['Divine Strike (+1d8 poison, 2d8 at 14th)'], 17: ['Improved Duplicity (four duplicates)'] },
    'Nature Domain': { 1: ['Acolyte of Nature', 'Bonus Proficiency'], 2: ['Charm Animals and Plants'], 6: ['Dampen Elements'], 8: ['Divine Strike (+1d8 cold/fire/lightning, 2d8 at 14th)'], 17: ['Master of Nature (command charmed animals and plants)'] },
    'Knowledge Domain': { 1: ['Blessings of Knowledge'], 2: ['Visions of the Past'], 6: ['Read Thoughts'], 8: ['Potent Spellcasting (+WIS to cantrip damage)'] },
  },
  Ranger: {
    'Hunter': { 3: ["Hunter's Prey"], 7: ['Defensive Tactics'], 11: ['Multiattack'], 15: ["Superior Hunter's Defense (Evasion / Stand Against the Tide / Uncanny Dodge)"] },
    'Beast Master': { 3: ["Ranger's Companion"], 7: ['Exceptional Training'], 11: ['Bestial Fury'], 15: ['Share Spells (self-target spells also affect your companion)'] },
    'Gloom Stalker': { 3: ['Dread Ambusher', 'Umbral Sight'], 7: ['Iron Mind'], 11: ["Stalker's Flurry"], 15: ['Shadowy Dodge (reaction: impose disadvantage on an attack against you)'] },
    'Horizon Walker': { 3: ['Detect Portal', 'Planar Warrior'], 7: ['Ethereal Step'], 11: ['Distant Strike'], 15: ['Spectral Defense (reaction: resistance to an attack\'s damage)'] },
  },
  Paladin: {
    ...
    'Oath of Conquest': { 3: ['Conquering Presence', 'Guided Strike'], 7: ['Aura of Conquest'], 15: ['Scornful Rebuke'], 20: ['Invincible Conqueror (resist all damage, extra attack, crits on 19-20 for 1 min)'] },
    'Oathbreaker': { 3: ['Control Undead', 'Dreadful Aspect'], 7: ['Aura of Hate'], 15: ['Supernatural Resistance'], 20: ['Dread Lord (shadowy aura: frighten, shadow attacks, damage frightened creatures)'] },
  },
  Barbarian: {
    ...
    'Path of the Zealot': { 3: ['Divine Fury', 'Warrior of the Gods'], 6: ['Fanatical Focus'], 10: ['Zealous Presence'], 14: ['Rage Beyond Death (raging keeps you conscious at 0 HP)'] },
  },
  Bard: {
  ...
  Druid: {
    'Circle of the Land': { 2: ['Bonus Cantrip', 'Natural Recovery'], 3: ['Circle Spells'], 6: ["Land's Stride"], 10: ["Nature's Ward (immune to poison/disease; can't be charmed or frightened by elementals/fey)"], 14: ["Nature's Sanctuary (beasts and plants must save to attack you)"] },
    'Circle of the Moon': { 2: ['Combat Wild Shape', 'Circle Forms'], 6: ['Primal Strike'], 10: ['Elemental Wild Shape'], 14: ['Thousand Forms'] },
    'Circle of Spores': { 2: ['Halo of Spores', 'Symbiotic Entity'], 6: ['Fungal Infestation'], 10: ['Spreading Spores'], 14: ['Fungal Body (immune to blinded/deafened/frightened/poisoned; crits become normal hits)'] },

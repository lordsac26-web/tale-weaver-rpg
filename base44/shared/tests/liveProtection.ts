export const PROTECTED_DND_IDS = ['6a6825cd07a490fa70a46852','6a6825edd695bd65a4322256','6a7b8eea6d9cd7ede8b2d63b','6a767f23ec36fe219063ae49','6a77463582a26b50018110ea'];
...
export const readProtectedDndState = (db) => Promise.all([
  ...
  db.entities.CombatLog.get(PROTECTED_DND_IDS[2]),
  db.entities.CombatLog.get(PROTECTED_DND_IDS[3]),
  db.entities.CombatLog.get(PROTECTED_DND_IDS[4]),
]);
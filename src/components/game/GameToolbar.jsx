...
import { Dices, Map, ShoppingBag, Eye, Paintbrush, Scroll, BookMarked, MoreHorizontal, Moon } from 'lucide-react';
...
export default function GameToolbar({
  ...
  rollMode = 'ai', onRollModeChange, rollModeSaving = false,
}) {
  ...
  return (
    <div className="flex items-center gap-1.5 flex-shrink-0 overflow-x-auto">
      <RollModeToggle value={rollMode} onChange={onRollModeChange} disabled={rollModeSaving} />

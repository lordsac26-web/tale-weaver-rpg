...
export default function StoryPanel({ narrative, choices, loading, onChoice, customInput, setCustomInput, onCustomSubmit }) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden">
      ...
      {/* Narrative Area */}
      <div className="flex-1 overflow-y-auto p-5 md:p-7 min-h-0" style={{ background: 'transparent' }}>
        ...
        <div className="max-w-4xl mx-auto w-full space-y-2.5">
          {!loading && choices.length > 0 && (
            <div className="rounded-xl p-2.5 space-y-1.5"
              ...
              <div className="space-y-1.5 overflow-y-auto" style={{ maxHeight: 'min(28dvh, 18rem)' }}>
              <AnimatePresence>

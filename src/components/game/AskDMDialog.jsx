...
export default function AskDMDialog({ sessionId, onClose }) {
  ...
  return <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70 p-3" onClick={onClose}>
    <div className="w-full max-w-lg rounded-t-2xl sm:rounded-2xl p-5" onClick={event => event.stopPropagation()} style={{ background: 'rgba(15,10,5,0.99)', border: '1px solid rgba(120,160,220,0.45)', maxHeight: '90dvh', overflowY: 'auto' }}>

...
export const CLASSES = {
  ...
  Rogue: {
    ...
    skill_count: 4,
    subclasses: [
      { name: 'Thief', desc: 'Fast Hands (bonus action for many actions), Second-Story Work (climb without penalty), Supreme Sneak, Use Magic Device.', features: { 3: ['Fast Hands', 'Second-Story Work'], 9: ['Supreme Sneak'], 13: ['Use Magic Device'], 17: ["Thief's Reflexes (two turns in the first round)"] } },
      { name: 'Arcane Trickster', desc: 'Spellcasting (INT, Illusion & Enchantment), Mage Hand Legerdemain, Magical Ambush, Versatile Trickster.', features: { 3: ['Spellcasting', 'Mage Hand Legerdemain'], 9: ['Magical Ambush'], 13: ['Versatile Trickster'], 17: ['Spell Thief'] } },
      { name: 'Assassin', desc: 'Assassinate (advantage + auto-crit on surprised), Infiltration Expertise, Impostor.', features: { 3: ['Assassinate', 'Bonus Proficiencies'], 9: ['Infiltration Expertise'], 13: ['Impostor'], 17: ['Death Strike (double damage vs surprised targets, CON save)'] } },
      { name: 'Swashbuckler', desc: 'Fancy Footwork (no opportunity attacks after melee), Rakish Audacity (Sneak Attack with no ally nearby).', features: { 3: ['Fancy Footwork', 'Rakish Audacity'], 9: ['Panache'], 13: ['Elegant Maneuver'], 17: ['Master Duelist (reroll a missed attack, 1/short rest)'] } },
    ...
    features: {
      ...
      14: ['Blindsense'],
      15: ['Slippery Mind (WIS saving throw proficiency)'],
  ...
  Wizard: {
    ...
    subclasses: [
      ...
      { name: 'School of Abjuration', desc: 'Arcane Ward (absorbs damage for you), Projected Ward, Improved Abjuration, Spell Resistance.', features: { 2: ['Abjuration Savant', 'Arcane Ward'], 6: ['Projected Ward'], 10: ['Improved Abjuration'], 14: ['Spell Resistance (advantage on saves vs spells; resistance to spell damage)'] } },
      { name: 'School of Illusion', desc: 'Improved Minor Illusion, Malleable Illusions, Illusory Self (reaction negate attack), Illusory Reality.', features: { 2: ['Illusion Savant', 'Improved Minor Illusion'], 6: ['Malleable Illusions'], 10: ['Illusory Self'], 14: ['Illusory Reality (make an illusory object real for 1 minute)'] } },
      { name: 'School of Necromancy', desc: 'Grim Harvest (heal from killing spells), Undead Thralls, Inured to Undeath, Command Undead.', features: { 2: ['Necromancy Savant', 'Grim Harvest'], 6: ['Undead Thralls'], 10: ['Inured to Undeath'], 14: ['Command Undead (wrest control of an undead, CHA save)'] } },
      { name: 'School of Divination', desc: 'Portent (replace rolls with d20 rolls at dawn), Expert Divination, The Third Eye, Greater Portent.', features: { 2: ['Divination Savant', 'Portent'], 6: ['Expert Divination'], 10: ['The Third Eye'], 14: ['Greater Portent (roll three Portent dice at dawn)'] } },
      { name: 'School of Conjuration', desc: 'Minor Conjuration (create small objects), Benign Transposition, Focused Conjuration, Durable Summons.', features: { 2: ['Conjuration Savant', 'Minor Conjuration'], 6: ['Benign Transposition'], 10: ['Focused Conjuration'], 14: ['Durable Summons (summoned creatures gain 30 temp HP)'] } },
    ],
  ...
  Cleric: {
    ...
    skill_count: 2,
    subclasses: [
      { name: 'Life Domain', desc: 'Heavy Armor proficiency. Disciple of Life (+2+spell level healing). Preserve Life (pool = 5×level). Blessed Healer. Divine Strike (radiant). Supreme Healing.', features: { 1: ['Bonus Proficiency (Heavy Armor)', 'Disciple of Life'], 2: ['Preserve Life'], 6: ['Blessed Healer'], 8: ['Divine Strike (+1d8 radiant, 2d8 at 14th)'], 17: ['Supreme Healing (healing dice are maximized)'] } },
      { name: 'Light Domain', desc: 'Bonus cantrip (Light). Warding Flare (impose disadvantage on attacker). Radiance of the Dawn. Improved Flare. Corona of Light.', features: { 1: ['Bonus Cantrip', 'Warding Flare'], 2: ['Radiance of the Dawn'], 6: ['Improved Flare'], 8: ['Potent Spellcasting (+WIS to cantrip damage)'], 17: ['Corona of Light (aura of sunlight; disadvantage on saves vs fire/radiant spells)'] } },
      { name: 'War Domain', desc: 'Bonus proficiencies (martial + heavy). War Priest (bonus attack as bonus action). Guided Strike (+10 to attack). War God\'s Blessing.', features: { 1: ['Bonus Proficiencies', 'War Priest'], 2: ['Guided Strike'], 6: ["War God's Blessing"], 8: ['Divine Strike (+1d8 weapon damage, 2d8 at 14th)'], 17: ['Avatar of Battle (resistance to nonmagical B/P/S)'] } },
      { name: 'Trickery Domain', desc: 'Blessing of the Trickster (advantage on Stealth). Invoke Duplicity (illusion copy). Cloak of Shadows. Divine Strike (poison).', features: { 1: ['Blessing of the Trickster'], 2: ['Invoke Duplicity'], 6: ['Cloak of Shadows'], 8: ['Divine Strike (+1d8 poison, 2d8 at 14th)'], 17: ['Improved Duplicity (four duplicates)'] } },
      { name: 'Nature Domain', desc: 'Acolyte of Nature (druid cantrip + skill). Charm Animals and Plants. Dampen Elements (reduce elemental damage). Divine Strike (cold/fire/lightning).', features: { 1: ['Acolyte of Nature', 'Bonus Proficiency'], 2: ['Charm Animals and Plants'], 6: ['Dampen Elements'], 8: ['Divine Strike (+1d8 cold/fire/lightning, 2d8 at 14th)'], 17: ['Master of Nature (command charmed animals and plants)'] } },
      { name: 'Knowledge Domain', desc: 'Blessings of Knowledge (2 languages + skills + expertise). Visions of the Past. Read Thoughts. Potent Spellcasting.', features: { 1: ['Blessings of Knowledge'], 2: ['Visions of the Past'], 6: ['Read Thoughts'], 8: ['Potent Spellcasting (+WIS to cantrip damage)'] } },
    ],
    ...
    features: {
      ...
      5: ['Destroy Undead (CR ½)'],
      8: ['Destroy Undead (CR 1)', 'Domain Feature (Divine Strike / Potent Spellcasting)'],
      10: ['Divine Intervention (1/week)'],
      11: ['Destroy Undead (CR 2)'],
      14: ['Destroy Undead (CR 3)'],
      17: ['Destroy Undead (CR 4)'],
      20: ['Divine Intervention Improvement (automatic success)'],
    },
  },
  Ranger: {
    ...
    skill_count: 3,
    subclasses: [
      { name: 'Hunter', desc: 'Hunter\'s Prey (Colossus Slayer/Giant Killer/Horde Breaker). Defensive Tactics. Multiattack. Superior Hunter\'s Defense.', features: { 3: ["Hunter's Prey"], 7: ['Defensive Tactics'], 11: ['Multiattack'], 15: ["Superior Hunter's Defense (Evasion / Stand Against the Tide / Uncanny Dodge)"] } },
      { name: 'Beast Master', desc: 'Ranger\'s Companion (animal companion). Exceptional Training. Bestial Fury. Share Spells.', features: { 3: ["Ranger's Companion"], 7: ['Exceptional Training'], 11: ['Bestial Fury'], 15: ['Share Spells (self-target spells also affect your companion)'] } },
      { name: 'Gloom Stalker', desc: 'Dread Ambusher (extra attack + damage on first turn in combat). Umbral Sight (invisible in darkness). Iron Mind (WIS save proficiency). Stalker\'s Flurry.', features: { 3: ['Dread Ambusher', 'Umbral Sight'], 7: ['Iron Mind'], 11: ["Stalker's Flurry"], 15: ['Shadowy Dodge (reaction: impose disadvantage on an attack against you)'] } },
      { name: 'Horizon Walker', desc: 'Detect Portal, Planar Warrior (+1d8 force damage), Ethereal Step, Distant Strike, Spectral Defense.', features: { 3: ['Detect Portal', 'Planar Warrior'], 7: ['Ethereal Step'], 11: ['Distant Strike'], 15: ['Spectral Defense (reaction: resistance to an attack\'s damage)'] } },
    ],
    ...
    features: {
      ...
      14: ['Vanish (Hide as bonus action; cannot be tracked nonmagically)'],
      18: ['Feral Senses (attack unseen creatures without disadvantage)'],
      20: ['Foe Slayer (+WIS to one attack or damage roll vs favored enemy each turn)'],
    },
  },
  Paladin: {
    ...
    subclasses: [
      ...
      { name: 'Oath of Conquest', desc: 'Conquering Presence, Guided Strike. Aura of Conquest (frightened creatures can\'t move). Scornful Rebuke. Invincible Conqueror.', features: { 3: ['Conquering Presence', 'Guided Strike'], 7: ['Aura of Conquest'], 15: ['Scornful Rebuke'], 20: ['Invincible Conqueror (resist all damage, extra attack, crits on 19-20 for 1 min)'] } },
      { name: 'Oathbreaker', desc: 'Control Undead, Dreadful Aspect. Aura of Hate (+CHA to damage for you + undead). Supernatural Resistance. Dread Lord.', features: { 3: ['Control Undead', 'Dreadful Aspect'], 7: ['Aura of Hate'], 15: ['Supernatural Resistance'], 20: ['Dread Lord (shadowy aura: frighten, shadow attacks, damage frightened creatures)'] } },
    ],
    ...
    features: {
      ...
      14: ['Cleansing Touch (end a spell on yourself or an ally, CHA mod uses/long rest)'],
  ...
  Barbarian: {
    ...
    skill_count: 2,
    subclasses: [
      { name: 'Path of the Berserker', desc: 'Frenzy (extra attack as bonus action while raging, then exhaustion). Mindless Rage (immune to charm/frighten). Intimidating Presence. Retaliation.', features: { 3: ['Frenzy'], 6: ['Mindless Rage'], 10: ['Intimidating Presence'], 14: ['Retaliation'] } },
      ...
      { name: 'Path of the Zealot', desc: 'Divine Fury (radiant/necrotic damage while raging), Warrior of the Gods (revive without material cost), Fanatical Focus, Zealous Presence.', features: { 3: ['Divine Fury', 'Warrior of the Gods'], 6: ['Fanatical Focus'], 10: ['Zealous Presence'], 14: ['Rage Beyond Death (raging keeps you conscious at 0 HP)'] } },
    ],
    description: 'A fierce warrior of primitive background who can enter a battle rage.',
    features: {
      1: ['Rage (2/long rest — 3@3, 4@6, 5@12, 6@17, unlimited@20; +2 damage, +3@9, +4@16; resistance to B/P/S)', 'Unarmored Defense (10+DEX+CON AC)'],
  ...
  Druid: {
    ...
    skill_count: 2,
    subclasses: [
      { name: 'Circle of the Land', desc: 'Bonus Cantrip. Natural Recovery (regain spell slots on short rest). Circle Spells (based on terrain). Land\'s Stride. Nature\'s Ward. Nature\'s Sanctuary.', features: { 2: ['Bonus Cantrip', 'Natural Recovery'], 3: ['Circle Spells'], 6: ["Land's Stride"], 10: ["Nature's Ward (immune to poison/disease; can't be charmed or frightened by elementals/fey)"], 14: ["Nature's Sanctuary (beasts and plants must save to attack you)"] } },
      ...
      { name: 'Circle of Spores', desc: 'Halo of Spores (1d4 necrotic reaction). Symbiotic Entity (temporary HP + Halo damage). Fungal Infestation. Spreading Spores. Fungal Body.', features: { 2: ['Halo of Spores', 'Symbiotic Entity'], 6: ['Fungal Infestation'], 10: ['Spreading Spores'], 14: ['Fungal Body (immune to blinded/deafened/frightened/poisoned; crits become normal hits)'] } },
  ...
  Monk: {
    ...
    features: {
      ...
      2: ['Ki (points = monk level, recharge on short rest: Flurry of Blows, Patient Defense, Step of the Wind)', 'Unarmored Movement (+10 ft)'],
      ...
      9: ['Unarmored Movement Improvement (move along vertical surfaces and across liquids)'],

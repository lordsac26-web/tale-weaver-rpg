    ...
    <div className="min-h-screen parchment-bg" style={{ color: '#e8d5b7' }}>
      ...
      <div className="sticky top-0 z-20 flex items-center justify-between px-4 py-3"
        ...
        <div className="flex items-center gap-2 flex-wrap justify-center">
          ...
          <button onClick={() => navigate(createPageUrl('Progression') + `?character_id=${character?.id}` + (sessionId ? `&session_id=${sessionId}` : ''))}
          ...
          <button onClick={() => navigate(createPageUrl('InventoryPage') + `?character_id=${character?.id}`)}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                ...
                <span className="text-sm italic" style={{ color: 'rgba(222,185,132,0.9)', fontFamily: 'EB Garamond, serif' }}>
                  {character.race} {character.class}{character.subclass ? ` · ${character.subclass}` : ''}
                </span>
              </div>
              {character.alignment && (
                <div className="text-xs mt-1" style={{ color: 'rgba(205,170,120,0.82)', fontFamily: 'EB Garamond, serif' }}>
          ...
          <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 mt-4">
            {[
              ...
              <div key={label} className="stat-box rounded-xl p-2.5 text-center">
                ...
                <div className="text-xs mt-0.5" style={{ color: 'rgba(205,170,120,0.82)', fontFamily: 'EB Garamond, serif' }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <motion.div key={tab} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -4 }}
            ...
            {tab === 'stats' && (
              <div className="p-5">
                  ...
                  {STATS.map(stat => {
                    ...
                    return (
                      <div key={stat} className="stat-box rounded-xl p-4 text-center">
                        ...
                        <div className="font-fantasy text-xs tracking-widest mb-1" style={{ color: 'rgba(215,178,125,0.88)', fontSize: '0.62rem' }}>
                          {STAT_LABELS[stat]}
                        </div>
                ...
                <div className="rounded-xl p-3 stat-box text-center">
                  <span style={{ color: 'rgba(210,175,120,0.85)', fontFamily: 'EB Garamond, serif' }}>Proficiency Bonus: </span>
            ...
            {tab === 'skills' && (
              <div className="p-5 space-y-0.5">
                  ...
                  return (
                    <div key={skill} className="flex items-center justify-between py-2 px-3 rounded-lg transition-all group"
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-xs" style={{ color: 'rgba(200,165,115,0.78)' }}>({STAT_LABELS[stat]})</span>
                      </div>
                ...
                <div className="text-xs mt-3 pt-2" style={{ color: 'rgba(195,160,110,0.72)', fontFamily: 'EB Garamond, serif', borderTop: '1px solid rgba(180,140,90,0.08)' }}>
                    ...
                    return (
                      <div key={i} className="p-3 rounded-xl flex items-start justify-between gap-2"
                        ...
                        <div>
                          ...
                          <div className="text-xs mt-1" style={{ color: 'rgba(210,178,128,0.85)', fontFamily: 'EB Garamond, serif' }}>{condData.description}</div>
                        </div>
            ...
            {tab === 'features' && (
              <div className="p-5 space-y-3">
                ...
                {character.backstory && (
                  <div className="mt-4">
                    <div className="font-fantasy text-xs tracking-widest mb-2" style={{ color: 'rgba(218,180,128,0.85)', fontSize: '0.65rem' }}>BACKSTORY</div>
                    <div className="p-4 rounded-xl leading-relaxed text-sm"
                      style={{ background: 'rgba(15,10,4,0.7)', border: '1px solid rgba(180,140,90,0.12)', color: 'rgba(236,218,188,0.92)', fontFamily: 'IM Fell English, serif', lineHeight: '1.8' }}>
